...
describe("api/create", function(){
  ...
  describe("with a conflicting id", function(){
    ...
    it("throws an error", function(done){
      var data = { id: "conflict1" }; //keep changing this for every test run or drop the buckets before the test executes
  ...
  describe("with no conficting id", function(){
    it("saves the data with the specified id", function(done){
      var data = { id: "noconflict1" }; //keep changing this for every test run or drop the buckets before the test executes
